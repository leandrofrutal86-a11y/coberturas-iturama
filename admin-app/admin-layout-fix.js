...
/* Resultado da Equipe: cabeçalho vermelho e linhas alternadas branco/azul claro */
#equipe .box table{border-collapse:separate!important;border-spacing:0!important;overflow:hidden!important;border-radius:12px!important}
...
#equipe .box table thead th:first-child{border-top-left-radius:12px!important}
#equipe .box table thead th:last-child{border-top-right-radius:12px!important}
#equipe .box table tbody tr:nth-child(odd) td{background:#fff!important}
#equipe .box table tbody tr:nth-child(even) td{background:#eaf4fb!important}
