(()=>{
  ...
  function bind(){
    ...
    if(hist){hist.dataset.navfix='1';hist.onclick=()=>{if(typeof window.abrirHistorico==='function')window.abrirHistorico(hiddenTab('Histórico de Acesso'));else openWhenReady('Histórico de Acesso','historico')}}
