(()=>{
  ...
  function showDirectWhenReady(id,tries=0){if(showSection(id))return;if(tries<30)setTimeout(()=>showDirectWhenReady(id,tries+1),150)}
  function bind(){
    ...
    if(vis&&!vis.dataset.navfix){vis.dataset.navfix='1';vis.onclick=()=>showDirectWhenReady('visitasSubcanais')}
