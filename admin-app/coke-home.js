...
function nav(label){
 if(String(label)==='Histórico de Acesso'){const url=new URL('historico.html',window.location.href).href;try{window.top.location.assign(url)}catch{window.location.assign(url)}return}
