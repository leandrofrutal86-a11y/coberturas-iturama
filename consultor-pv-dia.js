...
function printReport(){
 ...
 @page{size:A4 landscape;margin:5mm}*{box-sizing:border-box}body{font-family:Arial,sans-serif;color:#111;margin:0}h1{font-size:14px;margin:0 0 2px}p{font-size:8px;margin:0 0 5px}.grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:4px}.pcard{border:1px solid #aaa;border-radius:5px;padding:4px;break-inside:avoid}.phead{display:flex;justify-content:space-between;gap:4px;align-items:center;font-size:8px}.ord{display:inline-block;background:#222;color:#fff;border-radius:999px;padding:2px 5px}.bad,.good{font-size:6.5px;font-weight:bold;border-radius:999px;padding:2px 4px}.bad{background:#fde0e0;color:#a00}.good{background:#def3e7;color:#075}.pname{font-size:9px;font-weight:bold;margin-top:2px}.psub{font-size:6.5px;color:#555;margin:1px 0 3px}.pmiss{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:2px}.pitem{border:1px solid #e5caca;background:#fff5f5;border-radius:3px;padding:2.5px;min-height:19px}.pitem b{display:block;font-size:6.2px;color:#900;line-height:1}.pitem.simple{display:flex;align-items:center;justify-content:space-between;gap:3px}.pitem.simple b{margin:0}.pitem.simple span{font-size:9px;font-weight:bold;color:#d00}.pprods{display:grid;gap:1px;margin-top:1px}.pprods span{font-size:6.2px;line-height:1;display:flex;gap:2px}.pprods i{font-style:normal;color:#d00;font-weight:bold}
